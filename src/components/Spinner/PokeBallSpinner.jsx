...
const PokeBallSpinner = () => {
    return (
        ...
        `}
            ...
            <g transform="translate(0.000000,3633.000000) scale(0.100000,-0.100000)" fill="#333333" stroke="black">
                <path className="" d="M17520 36320 c-2951 -116 -5710 -888 -8240 -2308 -3464 -1943 -6214
